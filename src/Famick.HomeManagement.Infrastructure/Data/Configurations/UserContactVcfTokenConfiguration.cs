...
public class UserContactVcfTokenConfiguration : IEntityTypeConfiguration<UserContactVcfToken>
{
    public void Configure(EntityTypeBuilder<UserContactVcfToken> builder)
    {
        builder.ToTable("user_contact_vcf_tokens");
