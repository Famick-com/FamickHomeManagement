...
public class CreateMealPlanEntryRequestValidator : AbstractValidator<CreateMealPlanEntryRequest>
{
    public CreateMealPlanEntryRequestValidator()
    {
